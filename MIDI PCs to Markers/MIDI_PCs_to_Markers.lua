...
--   Export and import presets as CSV files for easy sharing. Conversion can be applied to the whole session, or the time selection. A MIDI item with PCs has to be selected, when running. 
-- @changelog
--   1.0 - Initial release
